...
export default function Media(props, { children }) {
  return (
    <div class= "transparent" style={{ overflow: 'auto', height: 374, maxWidth: 550, padding: `1rem` }}>
      ...
      <Player playerTitle="Satire, BBC British, Dialog" playerSrc="../audio/BStansbury-F-M-Dialog-BBC-Brit.mp3" />
      <Player playerTitle="SciFi, American General, M/F Dialog" playerSrc="../audio/BStansbury-F-MF-Dialog-Am-Gen.mp3" />
